...
pub enum BluetoothRequest {
    RequestDevice(String, RequestDeviceoptions, IpcSender<BluetoothResponseResult>),
    GATTServerConnect(String, String, IpcSender<BluetoothResponseResult>),
    GATTServerDisconnect(String, String, IpcSender<BluetoothResult<bool>>),
    GetPrimaryService(String, String, String, IpcSender<BluetoothResponseResult>),
    GetPrimaryServices(String, String, Option<String>, IpcSender<BluetoothResponseResult>),
    GetIncludedService(String, String, String, IpcSender<BluetoothResponseResult>),
    GetIncludedServices(String, String, Option<String>, IpcSender<BluetoothResponseResult>),
    GetCharacteristic(String, String, String, IpcSender<BluetoothResponseResult>),
    GetCharacteristics(String, String, Option<String>, IpcSender<BluetoothResponseResult>),
    GetDescriptor(String, String, String, IpcSender<BluetoothResponseResult>),
    GetDescriptors(String, String, Option<String>, IpcSender<BluetoothResponseResult>),
    ReadValue(String, String, IpcSender<BluetoothResponseResult>),
    WriteValue(String, String, Vec<u8>, IpcSender<BluetoothResponseResult>),
